...
namespace SmartHomeAutomation.Migrations
{
    ...
    [Migration("20241203144206_EnergyUsages")]
    partial class EnergyUsages
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SmartHomeAutomation.Models.Device", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            LastUpdated = new DateTime(2024, 12, 3, 20, 12, 5, 814, DateTimeKind.Local).AddTicks(8659),
                            Location = "Ceiling",
                            Name = "Light",
                            RoomId = 1,
                            Status = "Active",
                        ...
                        new
                        {
                            ...
                            LastUpdated = new DateTime(2024, 12, 3, 20, 12, 5, 814, DateTimeKind.Local).AddTicks(8679),
                            Location = "Wall",
                            Name = "Thermostat",
                            RoomId = 2,
                            Status = "Active",
                        ...
                        new
                        {
                            ...
                            LastUpdated = new DateTime(2024, 12, 3, 20, 12, 5, 814, DateTimeKind.Local).AddTicks(8682),
                            Location = "Ceiling",
                            Name = "Fan",
                            RoomId = 3,
                            Status = "Inactive",
                        ...
                        new
                        {
                            DeviceId = 4,
                            ConfigurationSettings = "Brightness:100",
                            LastUpdated = new DateTime(2024, 12, 3, 20, 12, 5, 814, DateTimeKind.Local).AddTicks(8685),
                            Location = "Ceiling",
                            Name = "Fan",
                            RoomId = 1,
                            Status = "Active",
                        ...
                        new
                        {
                            DeviceId = 5,
                            ConfigurationSettings = "Temperature:72",
                            LastUpdated = new DateTime(2024, 12, 3, 20, 12, 5, 814, DateTimeKind.Local).AddTicks(8689),
                            Location = "Wall",
                            Name = "Microwave",
                            RoomId = 2,
                            Status = "Active",
                        ...
                        new
                        {
                            DeviceId = 6,
                            ConfigurationSettings = "Speed:3",
                            LastUpdated = new DateTime(2024, 12, 3, 20, 12, 5, 814, DateTimeKind.Local).AddTicks(8692),
                            Location = "Ceiling",
                            Name = "Light",
                            RoomId = 3,
                            Status = "Inactive",
