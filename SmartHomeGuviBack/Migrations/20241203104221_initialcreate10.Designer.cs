...
namespace SmartHomeAutomation.Migrations
{
    ...
    [Migration("20241203104221_initialcreate10")]
            ...
            modelBuilder.Entity("SmartHomeAutomation.Models.Device", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            LastUpdated = new DateTime(2024, 12, 3, 16, 12, 20, 691, DateTimeKind.Local).AddTicks(6195),
                            Location = "Ceiling",
                            Name = "Light",
                            RoomId = 1,
                            Status = "Active",
                        ...
                        new
                        {
                            ...
                            LastUpdated = new DateTime(2024, 12, 3, 16, 12, 20, 691, DateTimeKind.Local).AddTicks(6209),
                            Location = "Wall",
                            Name = "Thermostat",
                            RoomId = 2,
                            Status = "Active",
                        ...
                        new
                        {
                            ...
                            LastUpdated = new DateTime(2024, 12, 3, 16, 12, 20, 691, DateTimeKind.Local).AddTicks(6211),
                            Location = "Ceiling",
                            Name = "Fan",
                            RoomId = 3,
                            Status = "Inactive",
                        ...
                        new
                        {
                            DeviceId = 4,
                            ConfigurationSettings = "Brightness:100",
                            LastUpdated = new DateTime(2024, 12, 3, 16, 12, 20, 691, DateTimeKind.Local).AddTicks(6212),
                            Location = "Ceiling",
                            Name = "Fan",
                            RoomId = 1,
                            Status = "Active",
                        ...
                        new
                        {
                            DeviceId = 5,
                            ConfigurationSettings = "Temperature:72",
                            LastUpdated = new DateTime(2024, 12, 3, 16, 12, 20, 691, DateTimeKind.Local).AddTicks(6214),
                            Location = "Wall",
                            Name = "Microwave",
                            RoomId = 2,
                            Status = "Active",
                        ...
                        new
                        {
                            DeviceId = 6,
                            ConfigurationSettings = "Speed:3",
                            LastUpdated = new DateTime(2024, 12, 3, 16, 12, 20, 691, DateTimeKind.Local).AddTicks(6215),
                            Location = "Ceiling",
                            Name = "Light",
                            RoomId = 3,
                            Status = "Inactive",
