...
namespace SmartHomeAutomation.Migrations
{
    ...
    [Migration("20241207122915_settings")]
            ...
            modelBuilder.Entity("SmartHomeAutomation.Models.Device", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            LastUpdated = new DateTime(2024, 12, 7, 17, 59, 14, 142, DateTimeKind.Local).AddTicks(5505),
                            Location = "Ceiling",
                            Name = "Light",
                            RoomId = 1,
                            Status = "Active",
                        ...
                        new
                        {
                            ...
                            LastUpdated = new DateTime(2024, 12, 7, 17, 59, 14, 142, DateTimeKind.Local).AddTicks(5525),
                            Location = "Wall",
                            Name = "Thermostat",
                            RoomId = 2,
                            Status = "Active",
                        ...
                        new
                        {
                            ...
                            LastUpdated = new DateTime(2024, 12, 7, 17, 59, 14, 142, DateTimeKind.Local).AddTicks(5529),
                            Location = "Ceiling",
                            Name = "Fan",
                            RoomId = 3,
                            Status = "Inactive",
                        ...
                        new
                        {
                            DeviceId = 4,
                            ConfigurationSettings = "Brightness:100",
                            LastUpdated = new DateTime(2024, 12, 7, 17, 59, 14, 142, DateTimeKind.Local).AddTicks(5533),
                            Location = "Ceiling",
                            Name = "Fan",
                            RoomId = 1,
                            Status = "Active",
                        ...
                        new
                        {
                            DeviceId = 5,
                            ConfigurationSettings = "Temperature:72",
                            LastUpdated = new DateTime(2024, 12, 7, 17, 59, 14, 142, DateTimeKind.Local).AddTicks(5536),
                            Location = "Wall",
                            Name = "Microwave",
                            RoomId = 2,
                            Status = "Active",
                        ...
                        new
                        {
                            DeviceId = 6,
                            ConfigurationSettings = "Speed:3",
                            LastUpdated = new DateTime(2024, 12, 7, 17, 59, 14, 142, DateTimeKind.Local).AddTicks(5539),
                            Location = "Ceiling",
                            Name = "Light",
                            RoomId = 3,
                            Status = "Inactive",
