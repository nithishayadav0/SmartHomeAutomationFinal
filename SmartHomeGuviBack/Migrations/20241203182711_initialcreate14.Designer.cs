...
namespace SmartHomeAutomation.Migrations
{
    ...
    [Migration("20241203182711_initialcreate14")]
            ...
            modelBuilder.Entity("SmartHomeAutomation.Models.Device", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            LastUpdated = new DateTime(2024, 12, 3, 23, 57, 10, 105, DateTimeKind.Local).AddTicks(8715),
                            Location = "Ceiling",
                            Name = "Light",
                            RoomId = 1,
                            Status = "Active",
                        ...
                        new
                        {
                            ...
                            LastUpdated = new DateTime(2024, 12, 3, 23, 57, 10, 105, DateTimeKind.Local).AddTicks(8739),
                            Location = "Wall",
                            Name = "Thermostat",
                            RoomId = 2,
                            Status = "Active",
                        ...
                        new
                        {
                            ...
                            LastUpdated = new DateTime(2024, 12, 3, 23, 57, 10, 105, DateTimeKind.Local).AddTicks(8743),
                            Location = "Ceiling",
                            Name = "Fan",
                            RoomId = 3,
                            Status = "Inactive",
                        ...
                        new
                        {
                            DeviceId = 4,
                            ConfigurationSettings = "Brightness:100",
                            LastUpdated = new DateTime(2024, 12, 3, 23, 57, 10, 105, DateTimeKind.Local).AddTicks(8746),
                            Location = "Ceiling",
                            Name = "Fan",
                            RoomId = 1,
                            Status = "Active",
                        ...
                        new
                        {
                            DeviceId = 5,
                            ConfigurationSettings = "Temperature:72",
                            LastUpdated = new DateTime(2024, 12, 3, 23, 57, 10, 105, DateTimeKind.Local).AddTicks(8749),
                            Location = "Wall",
                            Name = "Microwave",
                            RoomId = 2,
                            Status = "Active",
                        ...
                        new
                        {
                            DeviceId = 6,
                            ConfigurationSettings = "Speed:3",
                            LastUpdated = new DateTime(2024, 12, 3, 23, 57, 10, 105, DateTimeKind.Local).AddTicks(8753),
                            Location = "Ceiling",
                            Name = "Light",
                            RoomId = 3,
                            Status = "Inactive",
